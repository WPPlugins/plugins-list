...
* PHP7 compatible
* Fully internationalized, ready for translations **If you would like to add a translation to his plugin then please head to our [Translating WordPress](https://translate.wordpress.org/projects/wp-plugins/plugins-list "Translating WordPress") page**
...
* Maintenance: Stopped the naughty behaviour of hard-coding the plugin folder name in INCLUDES
...
= 2.3.1 =
* Important bug fix plus some maintenance changes
